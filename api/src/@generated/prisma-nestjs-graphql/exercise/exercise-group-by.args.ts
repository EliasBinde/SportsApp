...
import { ExerciseAvgAggregateInput } from './exercise-avg-aggregate.input';
import { ExerciseSumAggregateInput } from './exercise-sum-aggregate.input';
...
export class ExerciseGroupByArgs {
    ...
    @Field(() => ExerciseAvgAggregateInput, {nullable:true})
    _avg?: ExerciseAvgAggregateInput;

    @Field(() => ExerciseSumAggregateInput, {nullable:true})
    _sum?: ExerciseSumAggregateInput;
